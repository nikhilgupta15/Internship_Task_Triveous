...
class RemoveTagfromBookmark extends Component {
  constructor() {
    super();
  ...
  onSubmit(e) {
    ...
    axios
      .post("http://localhost:5000/api/removeTagfromBookmark", data)
      ...
      <div>
        <form onSubmit={this.onSubmit} className="m-3">
          ...
          <div className="form-group">
            <input
              type="submit"
              value="Remove Tag from Bookmark"
...
export default RemoveTagfromBookmark;
